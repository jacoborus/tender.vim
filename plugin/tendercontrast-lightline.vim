if exists('g:tender_lightline') && g:tender_lightline
  ...
  let s:p.insert.left = [[["#1d1d1d", 234], ["#c4c773", 185]], [["#1d1d1d", 234], ["#a3aa39", 143]]]
  let s:p.insert.right = [[["#1d1d1d", 234], ["#c4c773", 185]], [["#1d1d1d", 234], ["#a3aa39", 143]]]
  let s:p.insert.middle = [[["#c4c773", 185], ["#444444", 238]]]
