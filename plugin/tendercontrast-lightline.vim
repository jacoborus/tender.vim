if exists('g:tender_lightline') && g:tender_lightline
  ...
  let s:p.normal.warning = [[["#1d1d1d", 234], ["#ffc24b", 215]]]
  ...
  let s:p.visual.left = [[["#1d1d1d", 234], ["#ffc24b", 215]], [["#1d1d1d", 234], ["#9b7425", 3]]]
  let s:p.visual.right = [[["#1d1d1d", 234], ["#ffc24b", 215]], [["#1d1d1d", 234], ["#9b7425", 3]]]
