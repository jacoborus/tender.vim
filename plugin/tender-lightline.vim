if exists('g:tender_lightline') && g:tender_lightline
  ...
  let s:p.normal.error = [[["#282828", 235], ["#f63550", 203]]]
  ...
  let s:p.insert.left = [[["#282828", 235], ["#c9cc74", 186]], [["#282828", 235], ["#a0a433", 143]]]
  let s:p.insert.right = [[["#282828", 235], ["#c9cc74", 186]], [["#282828", 235], ["#a0a433", 143]]]
  let s:p.insert.middle = [[["#c9cc74", 186], ["#444444", 238]]]
  let s:p.replace.left = [[["#282828", 235], ["#f63550", 203]], [["#282828", 235], ["#c12038", 125]]]
  let s:p.replace.right = [[["#282828", 235], ["#f63550", 203]], [["#282828", 235], ["#c12038", 125]]]
