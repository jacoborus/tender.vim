...
" Description: Tender Airline theme
...
let s:normal2 = [ "#1B2327", "#73cef4", 235, 81 ]
...
let s:insert2 = [ "#1B2327", "#9faa00", 235, 142 ]
...
let s:replace1 = [ "#1B2327", "#f43753", 235, 203 ]
let s:replace2 = [ "#1B2327", "#c5152f", 235, 160 ]
...
let s:visual1 = [ "#1B2327", "#ffc24b", 235, 215 ]
let s:visual2 = [ "#1B2327", "#715b2f", 235, 58 ]
...
" Generated by Estilo v2.0.0-alpha.2 (https://github.com/jacoborus/estilo)
