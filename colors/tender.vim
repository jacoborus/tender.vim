...
hi DiffAdd guifg=#eeeeee ctermfg=255 guibg=#a0a433 ctermbg=143 gui=NONE cterm=NONE
hi DiffChange guifg=#eeeeee ctermfg=255 guibg=#6bb9dc ctermbg=74 gui=NONE cterm=NONE
hi DiffDelete guifg=#282828 ctermfg=235 guibg=#f63550 ctermbg=203 gui=NONE cterm=NONE
hi DiffText guifg=#6bb9dc ctermfg=74 guibg=#eeeeee ctermbg=255 gui=bold cterm=bold
hi ErrorMsg guifg=#f63550 ctermfg=203 guibg=NONE ctermbg=NONE gui=reverse cterm=reverse
...
hi MatchParen guifg=#f63550 ctermfg=203 guibg=NONE ctermbg=NONE gui=bold cterm=bold
...
hi PMenuSel guifg=#282828 ctermfg=235 guibg=#c9cc74 ctermbg=186 gui=NONE cterm=NONE
...
hi SpellBad guifg=#f63550 ctermfg=203 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi WarningMsg guifg=#f63550 ctermfg=203 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi WildMenu guifg=#282828 ctermfg=235 guibg=#c9cc74 ctermbg=186 gui=bold cterm=bold
...
hi Operator guifg=#f63550 ctermfg=203 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi Exception guifg=#f63550 ctermfg=203 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi Error guifg=#eeeeee ctermfg=255 guibg=#f63550 ctermbg=203 gui=NONE cterm=NONE
hi Todo guifg=#f63550 ctermfg=203 guibg=NONE ctermbg=NONE gui=bold cterm=bold
hi cssVendor guifg=#a0a433 ctermfg=143 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi cssTagName guifg=#a0a433 ctermfg=143 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi cssIdentifier guifg=#a0a433 ctermfg=143 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi cssIncludeKeyword guifg=#ffc955 ctermfg=221 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi cssImportant guifg=#f63550 ctermfg=203 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi cssNoise guifg=#f63550 ctermfg=203 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi gitcommitSelectedType guifg=#a0a433 ctermfg=143 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi gitcommitDiscardedFile guifg=#f63550 ctermfg=203 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi helpNote guifg=#f63550 ctermfg=203 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi jsonKeywordMatch guifg=#f63550 ctermfg=203 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi jsonQuote guifg=#eeeeee ctermfg=255 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi jsonNoise guifg=#f63550 ctermfg=203 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi markdownH1 guifg=#a2d8ee ctermfg=153 guibg=NONE ctermbg=NONE gui=bold cterm=bold
hi markdownHeadingRule guifg=#f63550 ctermfg=203 guibg=NONE ctermbg=NONE gui=bold cterm=bold
hi markdownHeadingDelimiter guifg=#f63550 ctermfg=203 guibg=NONE ctermbg=NONE gui=bold cterm=bold
...
hi markdownIdDeclaration guifg=#a0a433 ctermfg=143 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi markdownError guifg=#f63550 ctermfg=203 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi vimCommentTitle guifg=#a0a433 ctermfg=143 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi vimError guifg=#eeeeee ctermfg=255 guibg=#f63550 ctermbg=203 gui=NONE cterm=NONE
...
hi yamlKeyValueDelimiter guifg=#f63550 ctermfg=203 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi FugitiveblameHash guifg=#a2d8ee ctermfg=153 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi FugitiveblameUncommitted guifg=#f63550 ctermfg=203 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi NERDTreeOpenable guifg=#f63550 ctermfg=203 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi GitGutterDelete guifg=#f63550 ctermfg=203 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi GitGutterChangeDelete guifg=#f63550 ctermfg=203 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi javaScriptOpSymbols guifg=#f63550 ctermfg=203 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi javaScriptParens guifg=#a2d8ee ctermfg=153 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi javaScriptDocTags guifg=#727436 ctermfg=243 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
