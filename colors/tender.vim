...
hi IncSearch guifg=#ffffff ctermfg=15 guibg=#040404 ctermbg=0 gui=Bold,reverse cterm=Bold,reverse
...
if exists('*term_setansicolors')
  ...
  let g:terminal_ansi_colors[1] = '#f43753'
  let g:terminal_ansi_colors[2] = '#c9d05c'
  let g:terminal_ansi_colors[3] = '#ffc24b'
  let g:terminal_ansi_colors[4] = '#b3deef'
  let g:terminal_ansi_colors[5] = '#d3b987'
  let g:terminal_ansi_colors[6] = '#73cef4'
  let g:terminal_ansi_colors[7] = '#eeeeee'
  let g:terminal_ansi_colors[8] = '#1d1d1d'
  let g:terminal_ansi_colors[9] = '#f43753'
  let g:terminal_ansi_colors[10] = '#c9d05c'
  let g:terminal_ansi_colors[11] = '#ffc24b'
  let g:terminal_ansi_colors[12] = '#b3deef'
  let g:terminal_ansi_colors[13] = '#d3b987'
  let g:terminal_ansi_colors[14] = '#73cef4'
